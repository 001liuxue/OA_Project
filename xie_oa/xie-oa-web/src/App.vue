  ...
  methods: {
    ...
    wechatLogin() {
      ...
      if(token === '' && openId != '') {
        ...
        if (token == '') {
          ...
          window.location = '	http://daisyxie.free.idcfengye.com/admin/wechat/authorize?returnUrl=' + url
        }
      }
    },
    ...
    saveBind() {
      ...
      userInfoApi.bindPhone(this.bindPhoneVo).then(response => {
        ...
        window.location = 'http://da.gz2vip.91tunnel.com'
      })
    },
